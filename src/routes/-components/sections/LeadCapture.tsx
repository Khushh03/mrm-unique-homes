...
export function LeadCapture() {
  ...
  return (
    <section
      id="lead-capture"
      className="max-w-7xl mx-auto px-6 md:px-20 py-16 select-none"
    >
            ...
            {!success ? (
              ...
              >
                ...
                <p className="font-sans text-xs sm:text-sm text-gray-500 leading-relaxed max-w-sm mx-auto">
                  Leave your details below. Our reservation concierge team will
                  contact you directly within 24 hours to coordinate a personal
                  viewing.
                </p>
                ...
                <form
                  ...
                  className="space-y-4 max-w-md mx-auto pt-2"
                >
              ...
              >
                ...
                <p className="font-sans text-xs sm:text-sm text-gray-500 leading-relaxed max-w-sm mx-auto font-light">
                  Thank you. An appointments concierge has queued your phone
                  line <strong>{phoneNumber}</strong> details. Expect our secure
                  call back contact within the next hour.
                </p>
                <div className="pt-2">
                  <button
                    onClick={() => {
